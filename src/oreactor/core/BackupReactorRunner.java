...
public class BackupReactorRunner {
	private ArgParser argParser;
	private Reactor reactor;

	BackupReactorRunner(String[] args) throws OpenReactorException {
	...
	public static void main(String[] args) throws OpenReactorException {
		/*
		// BackupReactorRunner reactorRunner = new BackupReactorRunner(args);
